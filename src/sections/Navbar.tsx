      ...
      <div className="w-full max-w-[1440px] mx-auto px-10 lg:px-20">
        <nav className="flex items-center justify-between h-[120px]">
          ...
          <a href="#hero" className="flex items-center gap-3 group">
            <div className="w-12 h-12 rounded-full border border-[#c9956b]/40 flex items-center justify-center">
              <img src="/images/logo.png" alt="Prime Protocol" className="w-8 h-8 object-contain" />
            </div>
            <div>
              <span className="font-serif text-[20px] font-semibold text-[#f5f0e8] tracking-[0.1em] uppercase">
                PRIME PROTOCOL
              </span>
