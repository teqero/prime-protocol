export default function WhoWeAre() {
  return (
    <section id="whoweare" className="w-full bg-[#111318] py-24 lg:py-32">
      <div className="w-full max-w-[1440px] mx-auto px-10 lg:px-20">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div>
            ...
            {/* Quote box */}
            <div className="bg-[#16181d] p-8 border-l-2 border-[#c9956b]">
              <p className="text-[12px] font-serif font-semibold text-[#c9956b] tracking-wide uppercase mb-4">
                Declaração de Missão
              </p>
              <p className="font-serif text-[20px] lg:text-[22px] text-[#f5f0e8] font-normal leading-[1.5]">
